...
const Terms = () => {
  return (
    <div className="container terms-page">
      <h2 className="text-center page-title">{tl8('terms.page_title')}</h2>

      <p className="body">Welcome to MHA!</p>

      <p className="body">
        These terms and conditions outline the rules and regulations for the use
        of MHA's Website, located at mental-health-assistance.netlify.app.
      </p>

      <p className="body">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use MHA if you do not agree to take all
      ...
      <p className="body">
        We employ the use of cookies. By accessing MHA, you agreed to use
        cookies in agreement with the MHA's Privacy Policy.{' '}
      </p>
      ...
      <p className="body">
        Unless otherwise stated, MHA and/or its licensors own the intellectual
        property rights for all material on MHA. All intellectual property
        rights are reserved. You may access this from MHA for your own personal
        use subjected to restrictions set in these terms and conditions.
      </p>

      <p className="body">You must not:</p>
      <ul className="body">
        <li>- Republish material from MHA</li>
        <li>- Sell, rent or sub-license material from MHA</li>
        <li>- Reproduce, duplicate or copy material from MHA</li>
        <li>- Redistribute content from MHA</li>
      </ul>

      <p className="body">
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. MHA
        ...
        of MHA,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, MHA shall not be liable for the Comments
      ...
      <p className="body">
        MHA reserves the right to monitor all Comments and to remove any
        Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </p>

      <p className="body">You warrant and represent that:</p>
      ...
      <p className="body">
        You hereby grant MHA a non-exclusive license to use, reproduce, edit and
      ...
      <p className="body">
        ...
        the hyperlink compensates the absence of MHA; and (d) the link is in the
      ...
      <p className="body">
        ...
        e-mail to MHA. Please include your name, your organization name, contact
      ...
      <p className="body">
        No use of MHA's logo or other artwork will be allowed for linking absent
      ...
      <p className="body">Please read Privacy Policy</p>
      <br />
      <h3 className="heading">
